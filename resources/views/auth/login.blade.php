    ...
    <main id="main">
        <section class="section section-access">
            <div class="section-header">
                ...
                @if(session('success'))
                    <div class="alert alert-success" style="color: rgb(26, 198, 78); font-size:16px; margin-top: 5px">
                        {{ session('success') }}
                    </div>
            ...
            <div class="section-content">
                <form class="form-access login-form js-login-form clearfix" method="POST" action="{{ route('login') }}" autocomplete="off">
                    @csrf
                    <div class="form-group form-group-phone">
                        <label for="inputPhoneEmailLogin">Email</label>
                        <input type="email" class="form-control" id="inputPhoneEmailLogin" required="" placeholder="" name="email">
                    </div>
                    ...
                    <div class="form-group clearfix">
                        ...
                        <a style="float: right;" href="{{ route('register')}}">Tạo tài khoản mới</a>
                    </div>
