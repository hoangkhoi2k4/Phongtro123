        ...
        <div class="d-none d-md-block">
            <div class="table-responsive">
                <table class="table table_post_listing table-bordered _table-hover">
                    ...
                    <tbody>
                        <h1 class="page-title-h1">Cho thuê phòng trọ, cho thuê nhà trọ, tìm phòng trọ <a href="{{ route('room.create')}}" title="Thêm mới">Thêm tin mới</a></h1>
                        @if($rooms)
                            @foreach($rooms as $item)
                                <tr class="t-center">
                                    ...
                                    <td>
                                        ...
                                        <p>
                                            <a style="color: #000; font-size:16px; margin-right: 3px" href=""><i class="fa-solid fa-arrows-rotate"></i>Đăng lại</a>
                                            <a style="color: #000; font-size:16px; margin-right: 3px" href=""><i class="fa-solid fa-eye-slash"></i>Ẩn tin</a>
                                            <a style="color: #000; font-size:16px; "href="{{ route('room.update', $item->id)}}"><i class="fa-solid fa-pencil"></i>Sửa tin</a>
                                        </p>
                                    </td>
                        ...
                        @else
                            <tr>
                                <td colspan="7">Bạn chưa có tin đăng nào. Bấm <a href="{{ route('room.create')}}">vào đây</a> để bắt đầu đăng tin</td>
                            </tr>
                        @endif
                    </tbody>
                </table>
