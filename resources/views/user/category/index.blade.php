...
@section('category')
    ...
    <header class="page-header category clearfix">
        ...
        <p class="page-description">Cho thuê căn hộ mini, chung cư mini Huyện Thanh Oai mới Nhất
            T8/2024, tất cả tin đăng cho thuê căn hộ mini Huyện Thanh Oai: giá rẻ, diện tích nhỏ,
