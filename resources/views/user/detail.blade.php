    ...
    <div class="container clearfix">
            ...
            <article class="the-post tin-vip vipnoibat">
                <div class="post-images">
                    <div class="images-swiper-container swiper-container-horizontal">
                        <div class="swiper-wrapper" style="transition: 0.5s;">
                            ...
                            <div class="swiper-slide" data-swiper-slide-index="0" style="width: 728px;">
                                <img alt="Cực phẩm KTX, Phòng trọ, Sang, Xịn, Mịn Giá siêu rẻ tại Thủ Đức" src="{{asset('user/asset/image/anh1.jpg')}}">
                            </div>
                            <div class="swiper-slide" data-swiper-slide-index="1" style="width: 728px;">
                                <img alt="Cực phẩm KTX, Phòng trọ, Sang, Xịn, Mịn Giá siêu rẻ tại Thủ Đức" src="{{asset('user/asset/image/anh2.jpg')}}">
                            </div>
                            <div class="swiper-slide" data-swiper-slide-index="2" style="width: 728px;">
                                <img alt="Cực phẩm KTX, Phòng trọ, Sang, Xịn, Mịn Giá siêu rẻ tại Thủ Đức" src="{{asset('user/asset/image/anh3.jpg')}}">
                            </div>
                            <div class="swiper-slide" data-swiper-slide-index="3" style="width: 728px;">
                                <img alt="Cực phẩm KTX, Phòng trọ, Sang, Xịn, Mịn Giá siêu rẻ tại Thủ Đức" src="{{asset('user/asset/image/anh4.jpg')}}">
                            </div>
                            <div class="swiper-slide" data-swiper-slide-index="4" style="width: 728px;">
                                <img alt="Cực phẩm KTX, Phòng trọ, Sang, Xịn, Mịn Giá siêu rẻ tại Thủ Đức" src="{{asset('user/asset/image/anh5.jpg')}}">
                            </div>
                            <div class="swiper-slide" data-swiper-slide-index="5" style="width: 728px;">
                                <img alt="Cực phẩm KTX, Phòng trọ, Sang, Xịn, Mịn Giá siêu rẻ tại Thủ Đức" src="{{asset('user/asset/image/anh6.jpg')}}">
                            </div>
                            <div class="swiper-slide swiper-slide-active" data-swiper-slide-index="6" style="width: 728px;">
                                <img alt="Cực phẩm KTX, Phòng trọ, Sang, Xịn, Mịn Giá siêu rẻ tại Thủ Đức" src="{{asset('user/asset/image/anh7.jpg')}}">
                            </div>
                            <div class="swiper-slide" data-swiper-slide-index="7" style="width: 728px;">
                                <img alt="Cực phẩm KTX, Phòng trọ, Sang, Xịn, Mịn Giá siêu rẻ tại Thủ Đức" src="{{asset('user/asset/image/anh8.jpg')}}">
                            </div>
                        </div>
                ...
                <header class="page-header">
                    <h1 class="page-h1">
                        ...
                        <a style="color: #E13427;" href="https://phongtro123.com/cuc-pham-ktx-phong-tro-sang-xin-min-gia-sieu-re-thu-duc-pr603516.html" title="Cực phẩm KTX, Phòng trọ, Sang, Xịn, Mịn Giá siêu rẻ tại Thủ Đức">Cực phẩm KTX, Phòng trọ, Sang, Xịn, Mịn Giá siêu rẻ tại Thủ Đức</a>
                    </h1>
                    ...
                    <div class="post-attributes">
                        <div class="item price">
                            <i></i>
                            <span style="color: #16c784; font-weight: bold; font-size: 1.5rem">1.2 triệu/tháng</span>
                        </div>
                        ...
                        <div class="item published">
                            <i></i>
                            <span title="Thứ 4, 06:40 14/08/2024">13 giờ trước</span>
                        </div>
                        ...
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a style="text-decoration: underline; " title="Phòng trọ Thủ Đức" href="https://phongtro123.com/tinh-thanh/ho-chi-minh/quan-thu-duc"><strong>Cho thuê phòng trọ Thủ Đức</strong></a>
                                    </td>
                                </tr>
                                <tr>
                ...
                <div class="post-fix-bar">
                    <div class="inner clearfix">
                        <div class="left-bar">
                            <span class="post-fix-bar-price">1.2 triệu/tháng 
                                <span style="color: #333; font-weight: normal;">- 30m<sup>2</sup>
                                </span>
                            </span>
                        ...
                        <div class="right-bar">
                            ...
                            <a class="post-fix-bar-zalo" rel="nofollow" target="_blank" href="https://zalo.me/0936456678">Nhắn Zalo</a>
                            <a class="post-fix-bar-phone" rel="nofollow" target="_blank" href="tel:0936456678">
                                <i></i> 
                                Gọi ngay 0936456678
                            </a>
                        </div>
        ...
        <aside id="aside">
            <div class="author-aside">
                ...
                <span class="author-name">Mr Bình</span>
                ...
                <a class="btn author-phone" rel="nofollow" href="tel:0936456678">
                    <i></i>
                    0936456678
                </a>
                <a class="btn author-zalo" target="_blank" rel="nofollow" href="https://zalo.me/0936456678">
                    <i></i> Nhắn Zalo
                </a>
            ...
            <section class="section section-aside-tinmoidang">
                ...
                <ul class="post-listing aside clearfix">
                    <li class="post-item clearfix tin-vip vipnoibat" post-id="603516">
                        <a href="/cuc-pham-ktx-phong-tro-sang-xin-min-gia-sieu-re-thu-duc-pr603516.html">
                            <figure>
                                <img class="lazy_done" src="https://pt123.cdn.static123.com/images/thumbs/450x300/fit/2022/07/03/f6480ee4-11fc-453b-882b-25f03a2bd77e_1656803279.jpg" data-src="https://pt123.cdn.static123.com/images/thumbs/450x300/fit/2022/07/03/f6480ee4-11fc-453b-882b-25f03a2bd77e_1656803279.jpg" alt="Cực phẩm KTX, Phòng trọ, Sang, Xịn, Mịn Giá siêu rẻ tại Thủ Đức" height="100" width="100" layout="responsive" data-loaded="true">
                            </figure>
                            <div class="post-meta">
                                <span class="post-title" style="color: #E13427;">
                                    <span class="star star-5"></span> Cực phẩm KTX, Phòng trọ, Sang, Xịn, Mịn Giá… 
                                </span>
                                <span class="post-price">1.2 triệu/tháng</span>
                                <time class="post-time" title="Thứ 4, 06:40 14/08/2024">13 giờ trước</time>
                            </div>
                        </a>
                    </li>
